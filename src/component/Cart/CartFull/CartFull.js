...
import classes from "./CartFull.module.scss"
...
const CartFull = () => {
    ...
    const onClearCart = () => {
        if(window.confirm('Вы действительно хотите очстить корзину?')) {
            dispatch(clearCart())
        }
    }
    ...
    return (
        <div className={classes.cart__full}>
            <div className={classes.cart__full__wrapper}>
                <div className={classes.cart__full__top}>
                    <div className={classes.cart__top__title}>
                    ...
                    <div className={classes.cart__top__clear}>
                        <div onClick={onClearCart} className={classes.cart__top__clear__wrap}>
                ...
                <div className={classes.total}>
                    ...
                    <p>Сумма заказа: <span style={{color: "#EB5A1E"}}>{totalPrice} ₽</span></p>
                </div>
                <div className={classes.cart__full__button}>
                    <NavLink to="/">
                        <button className={classes.button__back}><span>Вернуться назад</span></button>
                    </NavLink>
                    <button className={classes.button__pay}><span>Оплатить сейчас</span></button>
                </div>
            </div>
        </div>
    )
